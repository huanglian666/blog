...
![v2-1b379f20419869e262997606ea5fd4ed_720w](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/v2-1b379f20419869e262997606ea5fd4ed_720w.png)
...
![1561217892717-1418fb9b-7faa-4324-87b9-f1740329f564](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/1561217892717-1418fb9b-7faa-4324-87b9-f1740329f564.jpeg)
...
![image-20210816151513489](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210816151513489.png)
...
![image-20210816150721928](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210816150721928.png)



5：启动（nacos-server-1.4.1\nacos\bin\startup.cmd）



## 3.2：nacos注册中心工作流程   （重点）

![image-20201025201055054](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20201025201055054.png)

服务同步：不重要

#### 5秒发送服务心跳，15秒没有收到健康状况是false，30秒没有收到剔除   （重点）
...
1创建一个maven的父级项目，删掉src目录，

2pom.xml文件，package类型改成pom，boot版本2.3.2.RELEASE

  springcloud Hoxton.SR9  springcloud alibaba 2.2.6.RELEASE    

二 ：子模块

1 新建maven模块,引入spring web依赖，引入actuator监控场景依赖，引入nacos依赖

2 配置文件，指明项目的服务名字、端口、nacos的连接配置

3启动类 ，需要加入@EnableDiscoveryClient注解
...
1 初始化一个RestTemplate模板类,加上@Bean注解，@LoadBalanced注解

2 调用方法以getForObject（）为例调用，当然还有其他方法
...
![image-20201017145706708](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20201017145706708.png)
...
![image-20201017153801040](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20201017153801040.png)
...
```properties
实现思路：
新建一个商品模块qf-cloud-good1,复制 qf-cloud-goods的pom.xml到good1，配置文件需要保证服务名和qf-cloud-goods的服务名一致，端口号不一致，其他代码可以复制qf-cloud-goods的，需保证方法的访问路径完全一致
...
**默认的namespace是public ，不能删除  （重要）**
**默认的group是DEFAULT-GROUP        （重要）**



1：创建namespace

![image-20210817102910080](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210817102910080.png)



2：发布服务到指定的namespace

![image-20210817103155453](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210817103155453.png)
...
## 6.2：Ribbon在项目中怎么使用   （重点）

第一步：pom依赖

> springcloud alibaba 对Ribbon做了兼容

![image-20201018110223408](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20201018110223408.png)
...
## 6.4：Ribbon源码追踪  （源码了解，策略是重点）

![image-20210817135810619](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210817135810619.png)
...
![image-20210817135834178](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210817135834178.png)
...
![image-20210817140127081](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210817140127081.png)



负载均衡

![image-20210817140537724](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210817140537724.png)
...
![image-20210716160640128](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210716160640128.png)

**默认的轮询机制： ZoneAvoidanceRule** **重点！！！**

**记住 随机，轮询，最小并发**   ****

## 6.5：切换Ribbon负载均衡策略   （重点）

![image-20210817142501714](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210817142501714.png)



![image-20210817142523916](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210817142523916.png)





## 6.6：服务实例列表同步更新（了解，35秒记住重点）



```
DynamicServerListLoadBalancer.updateListOfServers 每隔35秒获取一次最新服务列表 
...
![image-20210817150519355](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210817150519355.png)
...
![image-20210202093842513](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210202093842513.png)
...
![image-20210719092644814](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210719092644814.png)
...
![image-20210202105915087](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210202105915087.png)
...
![image-20210817162423528](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210817162423528.png)
...
![image-20210817163043484](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210817163043484.png)



### 8.3.4：接口调用

回到orders模块，扫描openfeign接口

![image-20210817163230467](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210817163230467.png)
...
![image-20201101203849080](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20201101203849080.png)
...
![image-20210818105637846](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210818105637846.png)

![image-20210818105858696](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210818105858696.png)



![image-20210818105927559](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210818105927559.png)
...
![image-20210818113759160](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210818113759160.png)
...
![image-20210904104615186](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210904104615186.png)



在各个微服务中引用变量

![image-20210904104645680](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210904104645680.png)
...
![image-20210818114421971](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210818114421971.png)
...
![image-20210818115930426](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210818115930426.png)



![image-20210818120253526](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210818120253526.png)



## 9.9：配置文件版本管理

![image-20210818120648847](../../../../../../Downloads/04/SpringCloud/springcloudalibaba/Nacos.assets/image-20210818120648847.png)
