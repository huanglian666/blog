...
![](./_pic/customer_address.png)

在UML类图中单向关联用一个带箭头的实线表示。上图表示每个顾客都有一个地址，这通过让Customer类持有一个类型为Address的成员变量类实现。

**2，双向关联**

![](./_pic/customer_product.png)
...
![](./_pic/image-20191229173422328.png)
...
![](./_pic/image-20191229173455149.png)
...
![](./_pic/image-20191229173518926.png)
...
![](./_pic/image-20191229173539838.png)
...
![](./_pic/image-20191229173554296.png)
